...
const Navigation : React.FC<ContactModelProps> = ({navSelection, onContactClick}) => {
    ...
    return(
        <div className="flex items-center z-[50] fixed top-0 w-[100vw] justify-center">
            ...
            <div className="md:flex hidden flex-row  justify-between items-center px-[20px] h-[60px] 2xl:h-[55px] rounded-[8px] ring-[0.5px] ring-[#727376] w-[90vw] mt-[13px]  bg-white text-black ">
                <a href="https://www.nivakaran.dev">
                    <div className="cursor-pointer flex flex-row items-center justify-center space-x-[5px]  text-[20px] text-black">
                        <Image alt="test" src={Logo} height={50} width={150} />
                ...
                <div className="flex flex-row items-center text-[17px] justify-between text-black  w-[35%]">
                    ...
                    <div onClick={onAboutClick} className={`${navSelection=='About' ? 'text-[#8B2020]' : ''} cursor-pointer hover:text-[#EFA130]`}>
                        <p>About</p>
                    </div>
                    <div onClick={onServicesClick} className={`${navSelection=='Services' ? 'text-[#8B2020]' : ''} cursor-pointer hover:text-[#EFA130]`}>
                        <p>Services</p>
                    </div>
                ...
                <div className="flex flex-row items-center justify-center space-x-[10px]">
                    <div>
                        <div onClick={onContactClick} className="cursor-pointer bg-[#4B4B4D] text-white px-[18px] text-[15px] ring-[0.8px] ring-gray-800 py-[7px] rounded-[5px]">
                            <p>Let's talk</p>
                        </div>
                    </div>
                    <div>
            ...
            <div className="md:hidden flex flex-row  justify-between items-center px-[20px] h-[60px] 2xl:h-[55px] rounded-[8px] ring-[0.5px] ring-[#727376] w-[90vw] mt-[13px]  bg-white text-black ">
            ...
            <div className={`${isMenuOpen ? 'translate-x-0' : 'translate-x-[-100vw]' }  duration-500 md:hidden flex flex-row items-center  w-[100vw]  absolute top-0 left-0   cursor-pointer`}>
                ...
                <div className="bg-white w-[200%] z-[9999] h-[100vh]">
                    <div>
                ...
                <div onClick={onMenuClick} className={` ${isMenuOpen ? 'opacity-80 delay-300 duration-500 ' : 'opacity-0'}  md:hidden flex flex-col items-center w-[100%] h-[100vh] justify-center  bg-white ring-[0.5px] ring-[#727376]`}>
