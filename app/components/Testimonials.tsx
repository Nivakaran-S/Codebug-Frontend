        ...
        <div className="min-h-[120vh] py-[50px] w-screen flex items-center justify-center">
            <div className="w-[80%] mt-[40px] flex   flex-col">
                <div className="leading-[50px] sm:leading-[64px] blogs1 text-center">
                    <p className="text-[44px] sm:text-[55px] bg-gradient-to-t from-[#433D3A] via-[#C6C4C3] font-bold to-[#CAC8C6] bg-clip-text text-transparent">Testimonials</p>
                    <p className="text-[40px] sm:text-[55px] bg-gradient-to-t from-[#433D3A] via-[#C6C4C3] font-bold to-[#CAC8C6] bg-clip-text text-transparent">from Our Customers</p>
                </div>
